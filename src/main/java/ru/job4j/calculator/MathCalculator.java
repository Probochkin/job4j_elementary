...
public class MathCalculator {
    ...
    public static double differenceAndDivideAndMultiplyAndSum(double first, double second) {
        return difference(first, second)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + differenceAndDivideAndMultiplyAndSum(10, 20));
    }
}
